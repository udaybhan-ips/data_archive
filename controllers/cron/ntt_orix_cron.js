...
// var archiverJob = new CronJob ('25 10 * * *',function(){
...
// var billingControllerJob = new CronJob ('53 9 * * *',function(){
//     console.log('This is byokakin  billing start');
