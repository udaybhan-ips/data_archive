...
module.exports = {
    getSummaryByMonth: async function ({ year, month }) {
        ...
        try {
            ...
            const lastMonthData = `select dataid, cdrmonth, customercode, fixed_cost_subtotal, cdr_cost_subtotal, tax, total,
            carrier from  byokakin_billing_history where cdrmonth::date = '${lastYear}-${lastMonth}-01'`
            ...
            if (currentDataRes.rows) {
                return ([...currentDataRes.rows, ...lastMonthDataRes]);
            }
