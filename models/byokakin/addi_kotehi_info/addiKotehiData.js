...
module.exports = {
    ...
    addAddiKotehiInfo: async function (data) {
        ...
        try {
            ...
            let d_fd_n_number = "", product_name = "";
            if (data.d_fd_n_number !== undefined && data.d_fd_n_number !== '' && data.d_fd_n_number !== null) {
                d_fd_n_number = data.d_fd_n_number.trim();
            }

            if (data.product_name !== undefined && data.product_name !== '' && data.product_name !== null) {
            ...
            d_fd_n_number = '${d_fd_n_number}' and product_name='${data.product_name}' 
            ...
            const insertQuery = `insert into ntt_kddi_additional_kotehi_detail (customer_cd, customer_name, carrier, d_fd_n_number, 
                ...
                '3000-01-01','${data.added_by}',now(), '${data.modified_by}', now(), '${data.product_name}', ${carrier_amount}, ${ips_amount} ) returning id`;
