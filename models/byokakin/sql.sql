...
create table byokakin_ntt_Koteihi_202204 (cdrid bigint, did varchar(30), carrier varchar, service_name varchar, amount numeric(16,0), TAXCLASSIFICATION varchar, DAILYDISPLAY varchar, date_added timestamp without time zone);
...
bill_due__c timestamp without time zone, bill_sum__c numeric(16,2), bill_tax__c numeric(16,2), bill_notax__c numeric(16,2), bill_total__c numeric(16,2) )
