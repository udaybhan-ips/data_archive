create table byokakin_kddi_infinidata_202209 (cdrid serial, servicecode varchar(30), did varchar(30), usednumber varchar(30), cld varchar(30), calldate varchar(15), calltime varchar(15), callduration varchar(15), source varchar, destination varchar, terminaltype varchar);
...
create table byokakin_ntt_Koteihi_202209 (cdrid serial, did varchar(30), carrier varchar, service_name varchar, amount numeric(16,0),
 TAXCLASSIFICATION varchar, DAILYDISPLAY varchar, date_added timestamp without time zone, carrier_name varchar);

create table byokakin_ntt_rawcdr_inbound_202209 (cdrid serial, customername varchar, did varchar(30), calldate timestamp without time zone,
...
create table byokakin_ntt_rawcdr_outbound_202209 (cdrid serial, customername varchar, parentdid varchar(30), calltype varchar,
...
create table byokakin_ntt_processedcdr_202209 (cdrid bigint, cdrclassification varchar(10), customercode varchar(10), terminaltype varchar(10),
